...
namespace Tevador.RandomJS
{
    class GlobalFunction : Global
    {
        ...
        public readonly static GlobalFunction OBJC = new GlobalFunction("__objc", "(_,...__){ if(typeof _ == 'function') return new _(...__); return { [_]: __ }; }");
        ...
        public override void WriteTo(System.IO.TextWriter w)
        {
            ...
            if (References != null)
            {
                w.WriteLine(Declaration, References.Name);
            }
            else
            {
